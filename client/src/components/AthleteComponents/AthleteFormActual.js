...
<g className={front?"show":"hide"}>
	...
	<path class={injuryName=="Right Anterior Shoulder"?"st2":"st0"} onClick={()=>{setInjuryName("Right Anterior Shoulder");setShowSeverity(true)}} d="M91.6,162.2c0.2-0.1,0.3-0.3,0.5-0.4c7.4-5.9,15.2-12.1,17.4-22c-0.1-6,1.6-11.3,6.8-13.4
	...
	<path class={injuryName=="Right Anterior Shoulder"?"st2":"st0"} onClick={()=>{setInjuryName("Right Anterior Shoulder");setShowSeverity(true)}} d="M90.2,163.3c-0.1-3.7-1.7-6.9-3.4-10.4c-2.2-4.5-4.6-9.3-4.3-15.7c-1,3.1-1.8,6.5-2.2,10
	...
	<path class={injuryName=="Right Hip"?"st2":"st0"} onClick={()=>{setInjuryName("Right Hip");setShowSeverity(true)}} d="M118.2,279.5c-1.4-0.9-2.7-1.8-3.7-3.1c-0.1,1.2-0.3,2.5-0.4,3.8c1.4-0.4,2.5,0.1,3.3,1
		c0.9,0.9,1.4,2.4,1.8,4.1c2.8,0.1,3.1,0.2,4.8,0.8C122.7,282.5,120.4,280.9,118.2,279.5z"/>
	<path class={injuryName=="Right Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Right Forearm");setShowSeverity(true)}} d="M84.3,225c-0.2-0.7-0.4-1.4-0.5-2.1c-0.6,0.8-1.4,1.5-2.4,2.1c-1.4,0.9-3.3,1.4-5.4,1.7
	...
	<path class={injuryName=="Right Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Right Forearm");setShowSeverity(true)}} d="M70.9,261.8c0.5-0.8,1-1.6,1.6-2.3l0.5-0.7c1-1.4,2.4-3.1,3.5-5.4v-0.1c0.8-1.6,1.6-3.4,2.4-5.2
	...
	<path class={injuryName=="Right Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Right Forearm");setShowSeverity(true)}} d="M88.7,235.3c-4,3.6-6.3,8.8-8.4,13.6c-0.8,1.8-1.6,3.6-2.4,5.3v0.1c-1.2,2.3-2.6,4.2-3.7,5.6l-0.5,0.7
	...
	<path class={injuryName=="Right Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Right Forearm");setShowSeverity(true)}} d="M56.1,276.6c2.3-7.6,4.6-15.1,8.1-22.5c2.9-6,6.9-14.3,9.2-22.8c0.5-1.8,0.9-3.6,1.2-5.4v-0.1
	...
	<path class={injuryName=="Right Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Right Forearm");setShowSeverity(true)}} d="M53.9,258.6c0-0.1,0-0.2,0-0.3c-0.3,1.5-0.5,3-0.8,4.5c-1.2,6.8-2.4,13.7-4,20.9
		C54,275.3,53.9,266.6,53.9,258.6z"/>
	<path class={injuryName=="Right Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Right Forearm");setShowSeverity(true)}} d="M57.5,277c-2.6,8.7-5.3,17.4-9.9,26c0.4,0,0.9,0.1,1.3,0.1c3.3-6.6,7.3-15.9,10-25.1
		c1.6-5.4,2.8-10.6,3.2-15.1C60.4,267.7,58.9,272.4,57.5,277z"/>
	<path class={injuryName=="Right Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Right Forearm");setShowSeverity(true)}} d="M65.4,279.7c2-5.3,3.7-10.1,4.6-13.5c-2.6,4.5-5.2,10-7.5,15.7c-2.9,7.1-5.4,14.5-6.7,20.2
		C59.2,294.9,62.7,286.8,65.4,279.7z"/>
	<path class={injuryName=="Right Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Right Forearm");setShowSeverity(true)}} d="M60.7,308c1.1,0.8,2,1.7,2.6,2.7c3.9-19.5,11.7-34.4,18.5-47.6c0.2-0.3,0.3-0.5,0.5-0.8
	...
	<path class={injuryName=="Right Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Right Thigh");setShowSeverity(true)}} d="M138.4,340.5c-1-2.7-2-5.5-3.3-9c-0.3-0.7-0.5-1.5-0.8-2.2c0,0,0,0,0-0.1c-1.1-3.2-2-6.5-2.9-9.8v-0.1
		...
		/>
	<path class={injuryName=="Right Hip"?"st2":"st0"} onClick={()=>{setInjuryName("Right Hip");setShowSeverity(true)}} d="M128.6,303.4c0.6,2.3,1.2,4.6,1.8,7c0.3,1.3,0.7,2.7,1,4c0.1-2.6,0.1-5.4,0.1-8.2c-0.1-3.6-0.4-7.2-0.9-10.2
	...
	<path class={injuryName=="Right Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Right Thigh");setShowSeverity(true)}} d="M115,435.1c-0.6,2.9-1,6.9-1.3,11.1c10.8-5,6-20.9,2.1-34.1c-0.6-2-1.2-3.9-1.7-5.9c-7.8-28.2-5.8-45-3.9-60.4
	...
	<path class={injuryName=="Right Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Right Thigh");setShowSeverity(true)}} d="M131.2,412.1c0.6,4.2,1.1,8.5,1.8,12.9c0.5-4.2,1.3-8.5,2.1-12.5v-0.3c1.8-9.1,2.1-18.2,2.5-26.9
	...
	<path class={injuryName=="Right Hip"?"st2":"st0"} onClick={()=>{setInjuryName("Right Hip");setShowSeverity(true)}} d="M137.5,304c-1.6-1.7-3.3-3.6-5-5.7c0.3,2.5,0.5,5.2,0.5,7.8c0.1,4.8,0,9.5-0.3,13c0.7,2.6,1.5,5.3,2.3,7.9
		c1.2-2.4,2.2-5.1,3-8.1c0.9-3.7,1.4-8,1-13C138.6,305.2,138.1,304.6,137.5,304z"/>
	<path class={injuryName=="Right Groi"?"st2":"st0"} onClick={()=>{setInjuryName("Right Groi");setShowSeverity(true)}} d="M135.8,329c0.2,0.6,0.5,1.3,0.7,1.9c0.8,2.1,1.6,4.5,2.6,7c2.4-4.3,4-8.6,5.1-12.5c1.2-4.1,1.7-7.8,2-10.2
		c-0.3-0.4-0.5-0.9-0.8-1.3c-1.4-2.3-2.9-4.2-4.5-6.2c0.2,4.4-0.3,8.2-1.2,11.6C138.6,323,137.2,326.2,135.8,329z"/>
	<path class={injuryName=="Right Groi"?"st2":"st0"} onClick={()=>{setInjuryName("Right Groi");setShowSeverity(true)}} d="M139.8,340c5.4,14.7,9.9,27,12.7,40.1c6.1-15,2.9-27.5-0.5-40.5c-0.7-2.5-1.3-5-1.9-7.5
	...
	<path class={injuryName=="Right Groi"?"st2":"st0"} onClick={()=>{setInjuryName("Right Groi");setShowSeverity(true)}} d="M151.4,328c-0.4-1.1-0.8-2.2-1.2-3.4c0,0.1,0.1,0.3,0.1,0.5c0.5,2.9,1,5.7,1.3,6.6c0.6,2.5,1.2,5,1.8,7.4
	...
	<path class={injuryName=="Right Groi"?"st2":"st0"} onClick={()=>{setInjuryName("Right Groi");setShowSeverity(true)}} d="M156.4,372.4c-0.7,3.3-1.8,6.7-3.4,10.2c0.7,3.7,1.3,7.5,1.7,11.4c0.5-2.9,1-7.4,1.3-12.1
		C156.2,378.7,156.3,375.4,156.4,372.4z"/>
	<path class={injuryName=="Right Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Right Thigh");setShowSeverity(true)}} d="M149.1,408.6c-2-11.7-5.6-23.2-9.4-34.6c-0.3,3.7-0.4,7.6-0.6,11.5c-0.3,8.8-0.7,17.9-2.5,27.1l-0.1,0.3
	...
	<path class={injuryName=="Right Knee"?"st2":"st0"} onClick={()=>{setInjuryName("Right Knee");setShowSeverity(true)}} d="M146.8,444.4c0,5-2.1,11.5-3.8,16.6c-1.4,4.4-2.5,7.8-2,8c0.1,0.1,0.1,0.1,0.2,0.1c0.9,0.2,2-0.5,3.1-1.7
	...
	<path class={injuryName=="Right Leg"?"st2":"st0"} onClick={()=>{setInjuryName("Right Leg");setShowSeverity(true)}} d="M132.4,586.9c0-4.2-0.4-9.2-0.9-14.4c-0.5-5.6-1.2-11.4-2-16.9c-0.8-6-1.8-11.7-2.8-17.5
	...
	<path class={injuryName=="Right Leg"?"st2":"st0"} onClick={()=>{setInjuryName("Right Leg");setShowSeverity(true)}} d="M114.3,548.3c2.1,10.3,4.2,20.6,5,31.6l0.1,0.9c0.2,2,0.4,4.6,0.5,7.2c0.1,0,0.2,0,0.3,0
		...
		z"/>
	<path class={injuryName=="Right Leg"?"st2":"st0"} onClick={()=>{setInjuryName("Right Leg");setShowSeverity(true)}} d="M108.9,502.3c-0.1,2-0.2,4-0.2,6.1c0.3,10,1.6,19.2,3.3,28.2c-0.2-6.5-0.9-13-1.6-19.6
		C109.8,512.1,109.2,507.2,108.9,502.3z"/>
	<path class={injuryName=="Right Leg"?"st2":"st0"} onClick={()=>{setInjuryName("Right Leg");setShowSeverity(true)}} d="M125.8,587.9c0-9.3-2.9-23.6-5.1-34.7c-0.1-0.7-0.3-1.4-0.4-2.1c1.4,13.1,2.8,30.1,1.4,36.9
		C123.1,588.1,124.4,588,125.8,587.9z"/>
	<path class={injuryName=="Right Leg"?"st2":"st0"} onClick={()=>{setInjuryName("Right Leg");setShowSeverity(true)}} d="M128.9,587.5c0.3-3.3-0.1-7.1-0.7-10.8c-1-6.1-2.7-11.8-3.6-14.5c-0.6-1.8-1.2-3.6-1.7-5.3
		c2,10.3,4.3,22.4,4.3,30.8C127.8,587.7,128.4,587.6,128.9,587.5z"/>
	<path class={injuryName=="Abs"?"st2":"st0"} onClick={()=>{setInjuryName("Abs");setShowSeverity(true)}} d="M153.8,258.8c-4.4-0.2-9.1-0.5-13.4-1.1c-0.6,5.2,0.1,11.2,1.4,17.6c1.4,6.7,3.6,13.7,5.7,20.5
	...
	<path class={injuryName=="Abs"?"st2":"st0"} onClick={()=>{setInjuryName("Abs");setShowSeverity(true)}} d="M164.2,233c-0.7-0.3-7.7,0.3-14,1.2c-5,0.7-9.4,1.5-9.9,2c0,0-0.1,0.1-0.1,0.2c-0.7,1.3-0.9,5.2-0.7,8.9
	...
	<path class={injuryName=="Abs"?"st2":"st0"} onClick={()=>{setInjuryName("Abs");setShowSeverity(true)}} d="M141.7,211.6c6-4,16.1-10.9,23.4-12.9v-1.1c-0.1-4.3-0.3-10.8-2.8-16.4c-1,0.8-2.3,1.4-3.7,1.8
		c-4.3,1.3-10.4,1.1-18,0.4c-0.9,3.6-1.4,9.7-1.4,15.7c0,5.1,0.4,10.1,1.3,13.4L141.7,211.6z"/>
	<path class={injuryName=="Abs"?"st2":"st0"} onClick={()=>{setInjuryName("Abs");setShowSeverity(true)}} d="M140.7,230.9c2.4-1,6.9-1.4,11.4-1.8c5.3-0.5,10.6-1,11.8-2.2c0.6-0.6,1-5.2,1.1-10.3
	...
	<path class={injuryName=="Left Anterior Shoulder"?"st2":"st0"} onClick={()=>{setInjuryName("Left Anterior Shoulder");setShowSeverity(true)}} d="M197.8,121.7c2.2,0.3,4.4,0.7,6.5,1.1c5.3,1,10.2,2.2,13.8,3.7c5.2,2.2,6.9,7.4,6.8,13.4
	...
	<path class={injuryName=="Left Anterior Shoulder"?"st2":"st0"} onClick={()=>{setInjuryName("Left Anterior Shoulder");setShowSeverity(true)}} d="M247.6,152.9c-1.7,3.5-3.3,6.7-3.4,10.4c3.3,2.7,6.5,5.4,9,8.5c1.7-8.4,2-16.9,1-24.6c-0.5-3.5-1.2-6.8-2.2-10
	...
	<path class={injuryName=="Abs"?"st2":"st0"} onClick={()=>{setInjuryName("Abs");setShowSeverity(true)}} d="M169.4,198.7c7.3,2.1,17.4,8.9,23.4,12.9l1.2,0.9c0.9-3.3,1.3-8.3,1.3-13.4c0-6-0.5-12-1.4-15.7
		c-7.7,0.6-13.7,0.9-18-0.4c-1.4-0.4-2.7-1-3.7-1.8c-2.6,5.6-2.7,12.1-2.8,16.4V198.7z"/>
	<path class={injuryName=="Abs"?"st2":"st0"} onClick={()=>{setInjuryName("Abs");setShowSeverity(true)}} d="M170.5,226.8c1.2,1.3,6.5,1.7,11.8,2.2c4.5,0.4,9.1,0.8,11.5,1.8c0-0.9,0.1-1.9,0.1-2.9c0.1-3.1,0.2-6.5,0-9.2
		c-3.8-3.1-8.6-6.3-13.1-8.9c-4.3-2.5-8.2-4.4-10.5-5c-0.6,2.8-0.8,7.4-0.7,11.7C169.5,221.6,169.9,226.2,170.5,226.8z"/>
	<path class={injuryName=="Abs"?"st2":"st0"} onClick={()=>{setInjuryName("Abs");setShowSeverity(true)}} d="M170.3,251.5c0.6,1.3,1.5,2.2,2.7,2.3c3.1,0.3,6.9,0.5,10.7,0.5c3.7-0.1,7.3-0.4,9.8-1.4
	...
	<path class={injuryName=="Abs"?"st2":"st0"} onClick={()=>{setInjuryName("Abs");setShowSeverity(true)}} d="M185.1,302.8c0.5-2.3,1-4.7,1.8-7.1c2.2-6.8,4.3-13.8,5.7-20.5c1.4-6.4,2-12.4,1.4-17.6c-4.3,0.6-9,1-13.4,1.1
		c-4.3,0.2-8.3,0.1-11.1-0.2l0.1,66.4c1.4-0.5,3.3-2,5.3-3.8c3.1-2.9,6.2-6.6,7.3-8.6C183.6,309.6,184.3,306.3,185.1,302.8z"/>
	<path class={injuryName=="Left Hip"?"st2":"st0"} onClick={()=>{setInjuryName("Left Hip");setShowSeverity(true)}} d="M217,281.1c0.9-0.9,1.9-1.3,3.3-1c-0.1-1.3-0.3-2.5-0.4-3.8c-1,1.3-2.4,2.2-3.7,3.1c-2.2,1.4-4.5,3-5.8,6.5
		c1.7-0.6,2-0.7,4.8-0.8C215.6,283.5,216.1,282.1,217,281.1z"/>
	<path class={injuryName=="Left Hip"?"st2":"st0"} onClick={()=>{setInjuryName("Left Hip");setShowSeverity(true)}} d="M203.7,296c-0.5,3-0.8,6.6-0.9,10.2c-0.1,2.8-0.1,5.7,0,8.2c0.4-1.3,0.7-2.7,1-4c0.6-2.3,1.2-4.7,1.8-7
	...
	<path class={injuryName=="Left Hip"?"st2":"st0"} onClick={()=>{setInjuryName("Left Hip");setShowSeverity(true)}} d="M201.9,298.3c-1.8,2.1-3.4,4-5,5.7c-0.5,0.6-1.1,1.2-1.6,1.8c-0.4,5,0.1,9.3,1,13c0.8,3,1.9,5.7,3,8.1
		c0.8-2.6,1.6-5.2,2.3-7.9c-0.3-3.5-0.4-8.2-0.3-13C201.4,303.4,201.6,300.8,201.9,298.3z"/>
	<path class={injuryName=="Left Groin"?"st2":"st0"} onClick={()=>{setInjuryName("Left Groin");setShowSeverity(true)}} d="M198,331c0.2-0.6,0.5-1.3,0.7-1.9c-1.4-2.8-2.8-6-3.8-9.8c-0.9-3.4-1.4-7.2-1.2-11.6c-1.6,1.9-3.1,3.9-4.5,6.2
		c-0.3,0.5-0.5,0.9-0.8,1.3c0.3,2.5,0.8,6.1,2,10.2c1.1,3.9,2.7,8.2,5.1,12.5C196.3,335.5,197.2,333,198,331z"/>
	<path class={injuryName=="Left Groin"?"st2":"st0"} onClick={()=>{setInjuryName("Left Groin");setShowSeverity(true)}} d="M187.1,317.5c-0.1,0.3-0.2,0.5-0.3,0.7c-0.2,1.2-0.7,4.2-1.2,7.1s-1.1,5.8-1.3,6.7c-0.6,2.5-1.2,5-1.8,7.5
	...
	<path class={injuryName=="Left Groin"?"st2":"st0"} onClick={()=>{setInjuryName("Left Groin");setShowSeverity(true)}} d="M176.9,381.9c-0.5-8.2-0.6-17.2,0.1-20.8c0.2-7.5,2.1-14.7,3.9-22c0.6-2.4,1.2-4.9,1.8-7.4
	...
	<path class={injuryName=="Left Groin"?"st2":"st0"} onClick={()=>{setInjuryName("Left Groin");setShowSeverity(true)}} d="M178,372.4c0.1,3,0.2,6.3,0.4,9.4c0.3,4.8,0.8,9.3,1.3,12.1c0.4-3.9,1-7.7,1.7-11.4
		C179.8,379.1,178.7,375.7,178,372.4z"/>
	<path class={injuryName=="Left Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Left Thigh");setShowSeverity(true)}} d="M194.4,370.1C194.4,370.1,194.5,370.1,194.4,370.1c0.6-1.8,1.2-3.5,1.8-5.2c2.8-8.2,5.6-16.4,8-24.6
	...
	<path class={injuryName=="Left Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Left Thigh");setShowSeverity(true)}} d="M188.8,443.4C188.9,443.4,188.9,443.4,188.8,443.4c0.6,0.4,1.2,0.8,1.8,1.2c1.2,0.7,2.5,1.3,3.6,1.5
	...
	<path class={injuryName=="Left Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Left Thigh");setShowSeverity(true)}} d="M207.4,385.5c3-13.7,4.3-24.2,4.4-34.6c0.1-9-0.7-17.8-2-28.3c-1.2,6-2.5,12.1-4.2,18.2
	...
	<path class={injuryName=="Left Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Left Thigh");setShowSeverity(true)}} d="M203.7,444.5c1.3,0.1,2.6,0.3,4,0.3c2.8,0.2,5.7,0.2,8.5,0.2c-6.8-7.2-2.6-21.4,1-33.3
	...
	<path class={injuryName=="Right Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Right Thigh");setShowSeverity(true)}} d="M131.1,442.8c-1.3,0.1-2.6,0.3-4,0.3c-2.8,0.2-5.7,0.2-8.5,0.2c6.8-7.2,2.6-21.4-1-33.3
	...
	<path class={injuryName=="Left Knee"?"st2":"st0"} onClick={()=>{setInjuryName("Left Knee");setShowSeverity(true)}} d="M195,469c0.8,1.2,1.8,2.3,2.8,3.3c4,4,10.4,8.2,16.3,6.1h0.1l0,0l0,0l0,0c0,0,0.1,0,0.1-0.1
	...
	<path class={injuryName=="Right Knee"?"st2":"st0"} onClick={()=>{setInjuryName("Right Knee");setShowSeverity(true)}} d="M141.8,459.7c1.5-4.7,3.4-10.5,3.7-15.1c-0.3,0.1-0.5,0.3-0.7,0.4c-1.4,0.8-2.8,1.4-4.1,1.7
	...
	<path class={injuryName=="Left Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Left Thigh");setShowSeverity(true)}} d="M222.8,328.4c0.1,5.9,0.7,11.6,1.4,17.4c1.8,15.3,3.8,32.2-3.9,60.4c-0.5,2-1.1,3.9-1.7,5.9
	...
	<path class={injuryName=="Left Knee"?"st2":"st0"} onClick={()=>{setInjuryName("Left Knee");setShowSeverity(true)}} d="M190.2,467.4c1.1,1.2,2.2,1.8,3.1,1.7c0.1,0,0.2,0,0.2-0.1c0.5-0.2-0.6-3.6-2.1-8c-1.7-5.2-3.8-11.6-3.8-16.6
	...
	<path class={injuryName=="Left Leg"?"st2":"st0"} onClick={()=>{setInjuryName("Left Leg");setShowSeverity(true)}} d="M221.1,471.9c-0.3-2.4-0.2-4.1-0.1-6.2c0-0.7,0.1-1.3,0.1-2.1c0-0.3,0-0.5,0-0.9c-4.1,7.1-6.6,26.2-9,44.9
	...
	<path class={injuryName=="Left Leg"?"st2":"st0"} onClick={()=>{setInjuryName("Left Leg");setShowSeverity(true)}} d="M206.1,576.8c-0.6,3.7-0.9,7.4-0.7,10.8c0.6,0.1,1.1,0.1,1.7,0.2c0.1-8.4,2.3-20.4,4.3-30.8
		c-0.6,1.7-1.1,3.5-1.7,5.3C208.8,565,207.1,570.7,206.1,576.8z"/>
	<path class={injuryName=="Left Leg"?"st2":"st0"} onClick={()=>{setInjuryName("Left Leg");setShowSeverity(true)}} d="M213.7,553.2c-2.2,11.1-5,25.4-5.1,34.7c1.3,0.1,2.7,0.2,4.1,0.1c-1.4-6.8,0-23.8,1.4-36.9
		C214,551.8,213.9,552.5,213.7,553.2z"/>
	<path class={injuryName=="Left Leg"?"st2":"st0"} onClick={()=>{setInjuryName("Left Leg");setShowSeverity(true)}} d="M223.4,488c-0.2,3.6-0.5,7.7-0.8,11.5c-0.9,10.9-2.4,21.4-4.5,31.8c-0.2,1.1-0.5,2.2-0.7,3.3
	...
	<path class={injuryName=="Left Leg"?"st2":"st0"} onClick={()=>{setInjuryName("Left Leg");setShowSeverity(true)}} d="M225.7,508.4c0.1-2.1,0-4.1-0.2-6.1c-0.3,4.9-0.9,9.8-1.4,14.7c-0.7,6.6-1.4,13.1-1.6,19.6
		C224.1,527.6,225.4,518.4,225.7,508.4z"/>
	<path class={injuryName=="Left Ankle"?"st2":"st0"} onClick={()=>{setInjuryName("Left Ankle");setShowSeverity(true)}} d="M198.4,612.9c2,0.4,3.9,0.7,5.9,0.8c3.5,0.2,7,0.4,10.5,0c0.2-0.8,0.5-1.6,0.8-2.4c1.1-2.9,2.3-6.1-0.1-12.3
	...
	<path class={injuryName=="Left Foot"?"st2":"st0"} onClick={()=>{setInjuryName("Left Foot");setShowSeverity(true)}} d="M222.6,630.6c-2-2.3-4.2-5-6.4-8.8c-1.7-2.9-1.9-5.1-1.6-7c-3.3,0.3-6.7,0.2-10,0c-2-0.1-4-0.4-6-0.8
	...
	<path class={injuryName=="Right Ankle"?"st2":"st0"} onClick={()=>{setInjuryName("Right Ankle");setShowSeverity(true)}} d="M136.7,612.9c-2,0.4-3.9,0.7-5.9,0.8c-3.5,0.2-7,0.4-10.5,0c-0.2-0.8-0.5-1.6-0.8-2.4
		...
		"/>
	<path class={injuryName=="Right Foot"?"st2":"st0"} onClick={()=>{setInjuryName("Right Foot");setShowSeverity(true)}} d="M112.5,630.6c2-2.3,4.2-5,6.4-8.8c1.7-2.9,1.9-5.1,1.6-7c3.3,0.3,6.7,0.2,10,0c2-0.1,4-0.4,6-0.8
	...
	<path class={injuryName=="Left Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Left Forearm");setShowSeverity(true)}} d="M259.7,232.1c0-0.1-0.1-0.3-0.1-0.4c-0.5-1.7-0.9-3.3-1.2-5c-2.2-0.3-4-0.9-5.5-1.7c-0.9-0.6-1.7-1.3-2.3-2.1
		c-0.2,0.7-0.3,1.4-0.5,2.1v0.1c0,0.1-0.1,0.3-0.1,0.4c0.8,1,2.4,2.2,4.2,3.4C256.1,230.2,258.1,231.3,259.7,232.1z"/>
	<path class={injuryName=="Left Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Left Forearm");setShowSeverity(true)}} d="M284,303.5c-3.3-6.6-7.2-15.9-9.9-24.9c-2.2-7.2-3.6-14.2-3.3-19.6c-0.6-1.4-1.2-2.8-1.9-4.2
	...
	<path class={injuryName=="Left Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Left Forearm");setShowSeverity(true)}} d="M275,307.1c1.1-0.7,2.3-1.3,3.5-1.8c-3.9-7.8-7.8-17-10.9-25c-3-7.9-5.2-14.6-5.4-17.7c-0.5-0.7-1-1.4-1.4-2
	...
	<path class={injuryName=="Left Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Left Forearm");setShowSeverity(true)}} d="M259.8,225.9L259.8,225.9c0.3,1.8,0.7,3.6,1.2,5.4c2.3,8.4,6.3,16.8,9.2,22.8c3.5,7.4,5.8,14.9,8.1,22.5
	...
	<path class={injuryName=="Left Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Left Forearm");setShowSeverity(true)}} d="M286.8,303.1c-4.5-8.6-7.2-17.3-9.8-26c-1.4-4.7-2.9-9.4-4.6-14c0.4,4.5,1.6,9.8,3.1,15.1
		c2.7,9.1,6.7,18.5,10,25.1C285.9,303.2,286.4,303.1,286.8,303.1z"/>
	<path class={injuryName=="Left Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Left Forearm");setShowSeverity(true)}} d="M281.3,262.8c-0.3-1.5-0.5-3-0.8-4.5c0,0.1,0,0.2,0,0.3c0,8-0.1,16.7,4.8,25.1
		C283.7,276.5,282.5,269.5,281.3,262.8z"/>
	<path class={injuryName=="Left Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Left Forearm");setShowSeverity(true)}} d="M264.4,266.2c0.9,3.4,2.6,8.2,4.6,13.5c2.7,7.1,6.2,15.2,9.7,22.4c-1.3-5.8-3.8-13.1-6.7-20.2
		C269.6,276.2,267,270.7,264.4,266.2z"/>
	<path class={injuryName=="Left Forearm"?"st2":"st0"} onClick={()=>{setInjuryName("Left Forearm");setShowSeverity(true)}} d="M273.7,308c-1.8-10.2-5.1-19.1-8.8-26.5c-4.4-8.7-9.3-15.3-12.7-19.3c0.1,0.3,0.3,0.5,0.4,0.8
...
<path class="st0" d="M376.8,348.6c-0.8-0.5-1.7-1.1-2.6-1.8c-0.9-0.6-1.6-1.3-2.3-2c-0.2,0.4-0.5,0.8-0.7,1.2
	...
	<path class={injuryName=="Left Wrist"?"st2":"st0"} onClick={()=>{setInjuryName("Left Wrist");setShowSeverity(true)}} d="M420.2,318.4h-0.1l-2.4-0.8l0,0h-0.1l-3.5-1.2H414l-3.2-1.1h-0.1h-0.1l-4.4-1.5c-0.1,0-0.1,0-0.1-0.1l-4.9-1.6
	...
	<path class={injuryName=="Left Posterior Shoulder"?"st2":"st0"} onClick={()=>{setInjuryName("Left Posterior Shoulder");setShowSeverity(true)}} d="M451.1,162.7c0.1-0.1,0.2-0.3,0.3-0.3c0.3-0.3,0.6-0.6,0.9-0.9c5.7-6.2,10-12.5,10.3-14.3c0-0.1,0-0.1,0-0.1
	...
	<path class={injuryName=="Left Shoulder Blade"?"st2":"st0"} onClick={()=>{setInjuryName("Left Shoulder Blade");setShowSeverity(true)}} d="M464.1,145.5c2.4,1.4,4.8,3.6,7.6,6.1c0.6,0.5,1.2,1.1,1.8,1.7c-0.1-0.3-0.2-0.5-0.3-0.8
		c-2.1-4.9-5.3-12.5-9.1-12.9C464,141.5,464,143.5,464.1,145.5z"/>
	<path class={injuryName=="Left Shoulder Blade"?"st2":"st0"} onClick={()=>{setInjuryName("Left Shoulder Blade");setShowSeverity(true)}} d="M474.5,151.9c0.8,1.8,1.4,3.2,1.8,3.8c5.8,4.8,13.2,9.7,23.8,11.6c-2.1-5.6-2.4-10.1-2.7-14.8
	...
	<path class={injuryName=="Left Shoulder Blade"?"st2":"st0"} onClick={()=>{setInjuryName("Left Shoulder Blade");setShowSeverity(true)}} d="M483.3,173.8c5.1-0.3,10.7-1.7,16-5.2c-10.7-2-18.1-6.9-24-11.8l-0.1-0.1c-1.7-1.4-3.2-2.8-4.6-4.1
		c-2.4-2.1-4.5-4-6.5-5.4c0.3,7.2,1,14.7,2.1,22.2C469,171.9,475.6,174.2,483.3,173.8z"/>
	<path class={injuryName=="Left Middle Back"?"st2":"st0"} onClick={()=>{setInjuryName("Left Middle Back");setShowSeverity(true)}} d="M477.9,221.8c1.2,4,2,7.3,2.3,10.7c0,0.3,0.1,0.7,0.1,1c2,3.2,2.7,6,3.6,9c0.2,0.7,0.4,1.5,0.6,2.2
	...
	<path class={injuryName=="Trapez"?"st2":"st0"} onClick={()=>{setInjuryName("Trapez");setShowSeverity(true)}} d="M491.4,126.4C491.4,126.4,491.4,126.5,491.4,126.4c3.3,6.2,5.6,12.7,6.3,15.6c0.9,3.8,1.1,7.1,1.3,10.4
	...
	<path class={injuryName=="Trapez"?"st2":"st0"} onClick={()=>{setInjuryName("Trapez");setShowSeverity(true)}} d="M536.7,99.5c-4.2-2.6-7.9-5.4-10-7.6v122.7c4.8-15,12.1-27.2,17.4-36.2c2.6-4.3,4.7-7.8,5.8-10.5
	...
	<path class={injuryName=="Neck"?"st2":"st0"} onClick={()=>{setInjuryName("Neck");setShowSeverity(true)}} d="M526.7,68.8v20.6c1.3,2.1,5.7,5.4,10.8,8.7c3.6,2.3,7.4,4.5,10.8,6.2c-1-0.9-1.8-1.9-2.5-2.9
		c-3.4-2.4-5.8-7.2-7.6-12.5c-2.4-7.4-3.4-16.1-3.5-20.9C532.2,68.6,529.4,68.8,526.7,68.8z"/>
	<path class={injuryName=="Neck"?"st2":"st0"} onClick={()=>{setInjuryName("Neck");setShowSeverity(true)}} d="M525.2,89.5V68.8c-2.7-0.1-5.4-0.3-8-0.7c-0.1,4.8-1.1,13.4-3.5,20.9c-1.7,5.3-4.2,10-7.6,12.5
	...
	<path class="st0" d="M502.2,55.6c0.1,0.2,0.1,0.4,0,0.6c0.1,1.5,0.2,3,0.4,4.6c1.8,2,4.8,3.5,8.6,4.6c4.4,1.3,9.6,1.9,14.7,2
		...
		/>
	<path class={injuryName=="Right Shoulder Blade"?"st2":"st0"} onClick={()=>{setInjuryName("Right Shoulder Blade");setShowSeverity(true)}} d="M577.4,151.9c2-4.6,4.9-11.4,8.7-13.3c-3.5-1.7-6.3-3.5-8.8-5.2c-4.9-3.3-9.1-6.1-15.6-5.8
	...
	<path class={injuryName=="Right Posterior Shoulder"?"st2":"st0"} onClick={()=>{setInjuryName("Right Posterior Shoulder");setShowSeverity(true)}} d="M578.1,132.1c3.1,2,6.4,4.2,10.7,6.1h0.1c0.3,0.1,0.5,0.4,0.5,0.7c0,0,0,0,0,0.1c0.1,2.6,0.1,5.3,0,8v0.1
	...
	<path class={injuryName=="Right Shoulder Blade"?"st2":"st0"} onClick={()=>{setInjuryName("Right Shoulder Blade");setShowSeverity(true)}} d="M587.9,139.6c-3.8,0.4-7,7.9-9.1,12.9c-0.1,0.3-0.2,0.5-0.3,0.8c0.7-0.6,1.2-1.1,1.8-1.7
		c2.7-2.5,5.2-4.7,7.6-6.1C587.9,143.5,587.9,141.5,587.9,139.6z"/>
	<path class={injuryName=="Right Shoulder Blade"?"st2":"st0"} onClick={()=>{setInjuryName("Right Shoulder Blade");setShowSeverity(true)}} d="M587.8,147.3c-2,1.3-4.1,3.3-6.5,5.4c-1.4,1.3-3,2.7-4.6,4.1c-0.1,0-0.1,0.1-0.1,0.1
	...
	<path class={injuryName=="Right Middle Back"?"st2":"st0"} onClick={()=>{setInjuryName("Right Middle Back");setShowSeverity(true)}} d="M582.6,187.8c0.8-3.8,1.5-7.6,2.1-11.5c0.3-1.6,0.5-3.1,0.7-4.8c-3.5,2.1-9.8,4.1-16.9,3.7
	...
	<path class={injuryName=="Lower Back"?"st2":"st0"} onClick={()=>{setInjuryName("Lower Back");setShowSeverity(true)}} d="M541.1,231.7c-4.6-11.2-8.1-21.2-9.3-26.8c-2,4.7-3.7,9.7-5.2,15.1v77.5c5.6-7.5,11.2-12.5,16.6-15.8
		c4-2.4,7.9-3.8,11.6-4.6c0.8-0.1,1.6-0.3,2.4-0.4c-0.4-3.9-0.3-7.2,0.3-10C551.9,256.3,545.9,243.4,541.1,231.7z"/>
	<path class={injuryName=="Lower Back"?"st2":"st0"} onClick={()=>{setInjuryName("Lower Back");setShowSeverity(true)}} d="M525.2,219.9c-1.4-5.3-3.2-10.3-5.1-15c-1.2,5.6-4.7,15.6-9.2,26.8c-4.8,11.7-10.7,24.6-16.6,35
	...
	<path class={injuryName=="Gluteus"?"st2":"st0"} onClick={()=>{setInjuryName("Gluteus");setShowSeverity(true)}} d="M495.7,291.8c4.9-2.7,9.3-5.3,11.6-9.2c-3.6-2.1-7.1-3.3-10.5-4c-1-0.2-2-0.3-3-0.5l0,0
		c-2.5-0.3-4.9-0.2-7.2,0c-4,8.5-6.8,18.4-8.2,28.7C482.7,299.2,489.6,295.3,495.7,291.8z"/>
	<path class={injuryName=="Gluteus"?"st2":"st0"} onClick={()=>{setInjuryName("Gluteus");setShowSeverity(true)}} d="M521.1,356.8L521.1,356.8C521.2,356.7,521.2,356.7,521.1,356.8c1.9-1.9,3.3-3.9,4.1-6.1V300
	...
	<path class={injuryName=="Gluteus"?"st2":"st0"} onClick={()=>{setInjuryName("Gluteus");setShowSeverity(true)}} d="M569.8,352.1c4.1-10.9,5.6-23.6,4.8-36.4c-0.1-1.5-0.2-2.9-0.4-4.4c-4-9.8-11.8-14.3-18.7-18.2
	...
	<path class={injuryName=="Gluteus"?"st2":"st0"} onClick={()=>{setInjuryName("Gluteus");setShowSeverity(true)}} d="M558.3,278.1L558.3,278.1c-1,0.1-2,0.3-3,0.5c-3.4,0.7-6.9,2-10.5,4c2.3,3.9,6.7,6.4,11.6,9.2
	...
	<path class={injuryName=="Right Posterior Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Right Posterior Thigh");setShowSeverity(true)}} d="M571.1,374.1c-2.5-11.1-7.3-10-10.9-9.2c-1,0.2-2,0.4-2.8,0.4c-1,0.2-2.1,0.4-3.2,0.5
	...
	<path class={injuryName=="Right Posterior Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Right Posterior Thigh");setShowSeverity(true)}} d="M556.8,383.2c-0.6-6.1-1.9-12-4.2-17.1c-1.5,0.1-3.1,0-4.6-0.1c-3.5,6.5-5.8,16.1-7.3,26.1
	...
	<path class={injuryName=="Left Posterior Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Left Posterior Thigh");setShowSeverity(true)}} d="M506.8,484.6c-6.9-19-2.1-47.6,1.6-69.1c1.7-10,3.1-18.5,3-23.6c-1.5-10-3.9-19.5-7.3-26.1
	...
	<path class={injuryName=="Left Posterior Thigh"?"st2":"st0"} onClick={()=>{setInjuryName("Left Posterior Thigh");setShowSeverity(true)}} d="M493.2,402.1c-0.1-6.1-0.1-12.7,0.5-19.1c0.6-6,1.8-11.9,4.1-17.1c-1.1-0.1-2.2-0.3-3.2-0.5
	...
	<path class="st0" d="M575.9,428.8c-0.5,12.2-1,23.2,1.8,28.8c0-2.7,0.1-5.3,0.2-7.2c0.1-2.4,0.3-4.6,0.5-6.7
		...
		"/>
	<path class={injuryName=="Right Calf"?"st2":"st0"} onClick={()=>{setInjuryName("Right Calf");setShowSeverity(true)}} d="M578.7,481.4c-2.6-6-5-11.1-7.1-15.7c-1.3,0.5-3.5,2.1-5.5,5.6c-1.6,2.7-3.1,6.4-4,11.6l0,0l0,0
	...
	<path class={injuryName=="Right Calf"?"st2":"st0"} onClick={()=>{setInjuryName("Right Calf");setShowSeverity(true)}} d="M560.1,548.5c1.8-5,1.6-10.8,1.4-15.6c-0.7-5.8-0.8-12.1-0.9-18.1c0-2.8,0-5.6-0.1-8.2
	...
	<path class={injuryName=="Left Calf"?"st2":"st0"} onClick={()=>{setInjuryName("Left Calf");setShowSeverity(true)}} d="M489.7,514.7c0-2.8,0.1-5.6,0.1-8.2c0.2-4.8,0.3-9.7,0.3-14.4c0-3.2-0.1-6.4-0.3-9.1l0,0
	...
	<path class={injuryName=="Left Calf"?"st2":"st0"} onClick={()=>{setInjuryName("Left Calf");setShowSeverity(true)}} d="M505.2,489.7c-1.6-2.9-3-6.5-4.4-10.7c-0.5-0.6-1.1-1.3-1.6-2.2c-0.7-0.7-1.3-1.2-1.9-1.4
	...
	<path class={injuryName=="Right Achiles"?"st2":"st0"} onClick={()=>{setInjuryName("Right Achiles");setShowSeverity(true)}} d="M563,540.8c-0.1,2.8-0.6,5.7-1.6,8.4c-2,5.4-6.1,9.9-14.5,11.7l0.1,0.2c4.9,14.4,14.1,41.3,9.9,56.3
	...
	<path class={injuryName=="Left Achiles"?"st2":"st0"} onClick={()=>{setInjuryName("Left Achiles");setShowSeverity(true)}} d="M489.2,540.8c0.1,2.8,0.6,5.7,1.6,8.4c2,5.4,6.1,9.9,14.5,11.7l-0.1,0.2c-4.9,14.4-14.1,41.3-9.9,56.3
	...
	<path class={injuryName=="Right Wrist"?"st2":"st0"} onClick={()=>{setInjuryName("Right Wrist");setShowSeverity(true)}} d="M638.8,322.5l4.2-1.5h0.1l10.3-3.8c-0.9-1.1-1.7-2.7-2.6-5.1l-4.9,1.6c0,0-0.1,0-0.1,0.1l-4.4,1.5h-0.1h-0.1
	...
	{showSeverity? <div className="severity-container">
		<div className="how-much">
			...
			<button onClick={displaySeverity} className="submit-athlete-form ok-button">OK</button>
		</div>
